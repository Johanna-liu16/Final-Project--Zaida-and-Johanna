...
const getInfo = async (URLAddress) => {
  try {
    ...
    document.getElementById("info").innerHTML = "Capital: " + capital + "  Country: " + country + " Native Name: " + nativeName + " Continent: " + cont + " Population: " + pop + "  Language: " + lang + " Native language name: " + real + " Currency: " + money + " Currency symbol: " + symbol
